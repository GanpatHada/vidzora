...
export const createPlaylist = async (name: string, description: string, user_id: string) => {
...
export const isVideoInPlaylist = async (playlist_id: string, video_id: string) => {
    const { data, error } = await supabase
...
export const addVideoToPlaylist = async (playlist_id: string, video_id: string) => {
    const { data, error } = await supabase
        .from('playlist_videos')
...
export const deleteVideoFromPlaylist = async (playlist_id: string, video_id: string) => {
