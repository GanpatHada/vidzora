...
import WatchLaterVideoMenu from "./WatchLaterVideoMenu";
    ...
    <div className="flex gap-4 p-2 rounded-lg hover:bg-gray-700/50 transition-colors duration-200">
      ...
      <div className="shrink-0 ml-20">
        <WatchLaterVideoMenu
          ...
          onAddToFavorite={() => addToFavorite(String(video.id))}
          onRemoveFromWatchLater={() => removeFromWatchLater(String(video.id))}
        />
      </div>
    </div>
  );
